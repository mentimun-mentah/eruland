      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col col-lg-8">
            ...
            <div class="payment-card-row">
              <div class="alert alert-secondary w-100 alert-payment mb-0 p-2" role="alert">
                <i class="far fa-lightbulb-on mr-2"></i> Bayar sebelum {{momentExpiredDate(order.orders_created_at)}}
              </div>
            </div>
          ...
          <div class="col col-4 text-center align-self-center">
            ...
            <a :href="order.orders_pdf_url" target="_blank" class="btn btn-block border btn-sm">Cara Bayar</a>
            <button class="btn btn-block btn-danger btn-sm" @click="onCancelOrder(order.orders_order_id)">Batalkan</button>
            <button 
